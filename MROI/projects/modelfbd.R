...
holdout <-   cbind(
  ...
  ,fbd.rmd = fbd.posm1*0.0064719/3+fbd.rmd*1.781199e-05/2
...
decomp <- cbind(
  ...
  ,fbd.app = fbd.app*1.007945e-06
  ,fbd.edu = fbd.edu*9.573258e-04*0.02013463
  ,f400.wd = mc(f400.wd)* 0.16745636
  ,fbd.wd = mc(fbd.wd)* 0.45664618
  ,f300.avp = f300.avp*-0.06594102
  ,rx.dum = rx.dum * -0.04790382
)
