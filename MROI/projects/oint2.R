...
hold_ototal <- hold <- cbind(0
                             ...
                             ,o.rmd2b = o.rmd2b * 0.01631934  - o.rmd2b * 0.014631934  * y1
...
decomp <- as.data.frame(apply(cbind(
  ...
  ,cotvpdb = xbtb$cDigital$data[, 3] * -7.937059e-04
  ,ar.grp = ar.grp*0.3432135
  ,o5.wd = o5.wd *  6.448833
  ,o10.wd = o10.wd * -1.767194
  # ,o5.wd = o5.wd * 3.577860
  # ,o10.wd = o10.wd * 2.550287
...
# write.csv(decomp,'dc_oint_total.csv')
# write.csv(sc_o,'sc_oint_total.csv')
